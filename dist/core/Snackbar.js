...
const SnackBar = props => {
    const { id, action, anchorOrigin, autoHide = 6000, classes, icon, message, onClose, open, padding, margin, style, variant = 'info', className } = props, other = __rest(props, ["id", "action", "anchorOrigin", "autoHide", "classes", "icon", "message", "onClose", "open", "padding", "margin", "style", "variant", "className"]);
    const Icon = variants[variant].icon;
    return (react_1.default.createElement(core_1.Snackbar, { anchorOrigin: anchorOrigin, open: open, id: id, autoHideDuration: autoHide, style: Object.assign({ padding, margin }, style), className: className, onClose: onClose },
