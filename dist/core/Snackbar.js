...
const SnackBar = props => {
    const { id, action, anchorOrigin, autoHide = 6000, classes, icon, message, onClose, open, padding, margin, style, variant = 'info', className, TransitionComponent, TransitionProps } = props, other = __rest(props, ["id", "action", "anchorOrigin", "autoHide", "classes", "icon", "message", "onClose", "open", "padding", "margin", "style", "variant", "className", "TransitionComponent", "TransitionProps"]);
    const Icon = variants[variant].icon;
    return (react_1.default.createElement(core_1.Snackbar, { anchorOrigin: anchorOrigin, open: open, id: id, autoHideDuration: autoHide, style: Object.assign({ padding, margin }, style), className: className, TransitionComponent: TransitionComponent, TransitionProps: TransitionProps, onClose: onClose },
        react_1.default.createElement(core_1.SnackbarContent, Object.assign({ style: { backgroundColor: variants[variant].color }, "aria-describedby": 'client-snackbar', message: react_1.default.createElement("span", { id: 'client-snackbar', className: classes.message },
                ...
                react_1.default.createElement(core_1.IconButton, { key: 'close', "aria-label": 'Close', color: 'inherit', onClick: onClose },
                    react_1.default.createElement(icons_1.Close, null)) }, other))));
};
