...
class Sidebar extends react_1.Component {
    renderAction() {
        const { expanded = true, anchor = 'left', color = 'default', minWidth = 72, classes } = this.props;
        const iconToLeft = (anchor === 'left' && expanded)
            || (anchor === 'right' && !expanded);
        return (react_1.default.createElement(Action, { anchor: anchor },
            react_1.default.createElement(Button_1.default, { name: `button-${name || 'sidebar'}`, color: color, variant: 'contained', className: classes.button, style: { maxWidth: minWidth }, onClick: this.props.onToggle }, iconToLeft
