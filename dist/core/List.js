...
const List = (_a) => {
    ...
    return react_1.default.createElement(core_1.List, Object.assign({ subheader: title
            ? (react_1.default.createElement(core_1.ListSubheader, { className: classes ? classes[color] : '' }, title))
            : undefined, className: classes ? `${classes[color]} ${className}` : '', style: Object.assign({ padding, margin }, style) }, otherProps), children);
};
